...
public class MessageTemperatureComponent extends HorizontalLayout {
	...
	public MessageTemperatureComponent(Employee informationPassedEmployee,String temperaturePassedEmployee, LocalDateTime dateTimePassed) {
		...
		photo = new PushImage(informationPassedEmployee);
		...
		addClickListener(Desktop.getExtendedInformationListener(informationPassedEmployee.getFio(), informationPassedEmployee.getDivision(), informationPassedEmployee.getPosition(), informationPassedEmployee.getIdCard(), time, photo));
	}
